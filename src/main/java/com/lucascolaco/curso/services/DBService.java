...
import com.lucascolaco.curso.domain.Endereco;
import com.lucascolaco.curso.domain.Estado;
import com.lucascolaco.curso.domain.ItemPedido;
import com.lucascolaco.curso.domain.Pagamento;
...
import com.lucascolaco.curso.domain.enums.Perfil;
import com.lucascolaco.curso.domain.enums.TipoCliente;
...
import com.lucascolaco.curso.repositories.EnderecoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		categoriaRepository.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7)); // salvando os objetos no banco de dados
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "lucascolaco18@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "lucascolaco17@gmail.com", "62988455007", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("987845455", "412457878"));
		cli2.addPerfil(Perfil.ADMIN);
		
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300","Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "281738777012", cli2, c2);
